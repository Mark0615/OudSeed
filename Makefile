...
.PHONY: install test lint run check onboarding-prototype onboarding-prototype-real-meta onboarding-prototype-persistent onboarding-prototype-live-sync onboarding-live-sync-ready onboarding-sync-local-config ai-report-deploy-dry-run ai-report-status ai-report-ready ai-report-preflight ai-report-logs ai-report-post-run ai-report-verify clean
